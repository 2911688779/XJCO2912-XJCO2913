...
@Api(tags = "农作物-品种推荐")
@RestController
@RequestMapping(value = "/api/tuijianPinZhong")
public class TuijianPinZhongController {

    @Autowired
    private TuijianPinZhongService actionService;

    @ApiOperation(value = "save")
    @PostMapping(value = "/save")
    public ResponseUtil save(@RequestBody TuijianPinZhong action){

        TuijianPinZhong result = actionService.saveAction(action);
        return ResponseUtil.builder().success(true).data(result).build();
    }

    @ApiOperation(value = "update")
    @PostMapping(value = "/update")
    public ResponseUtil updateAction(@RequestBody TuijianPinZhong action){
    ...
    public ResponseUtil findAll(){
        List<TuijianPinZhong> actionsList = actionService.findAll();
    ...
    public @ResponseBody ResponseUtil findById(@PathVariable Integer id){
        TuijianPinZhong action = actionService.findById(id);
    ...
    @ApiOperation(value = "findYearMax")
    @GetMapping(value = "/findYearMax/{num}")
    public ResponseUtil findYearMax(@PathVariable String num){
        List<TuijianPinZhong> actionsList = actionService.findYearMax(num);
        return ResponseUtil.builder().success(true).data(actionsList).build();
    }
}
