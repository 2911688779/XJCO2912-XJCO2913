...
@Api(tags = "农作物-气象-日")
@RestController
@RequestMapping(value = "/api/qixiangDay")
public class QixiangDayController {

    @Autowired
    private QixiangDayService actionService;

    @ApiOperation(value = "save")
    @PostMapping(value = "/save")
    public ResponseUtil save(@RequestBody QixiangDay action){

        QixiangDay result = actionService.saveAction(action);
        return ResponseUtil.builder().success(true).data(result).build();
    }

    @ApiOperation(value = "update")
    @PostMapping(value = "/update")
    public ResponseUtil updateAction(@RequestBody QixiangDay action){
    ...
    public ResponseUtil findAll(){
        List<QixiangDay> actionsList = actionService.findAll();
    ...
    public @ResponseBody ResponseUtil findById(@PathVariable Integer id){
        QixiangDay action = actionService.findById(id);
    ...
    public @ResponseBody ResponseUtil findByDay(@PathVariable String day){
        List<QixiangDay> action = actionService.findByDay(day);
        return ResponseUtil.builder().success(true).data(action).build();
    }
    ...
    public @ResponseBody ResponseUtil findByBetweenDate(@PathVariable String startdate,@PathVariable String enddate){
        List<QixiangDay> action = actionService.findByBetweenDate(startdate, enddate);
        return ResponseUtil.builder().success(true).data(action).build();
    }
}
