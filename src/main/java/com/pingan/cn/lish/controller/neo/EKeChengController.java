...
@RestController
@RequestMapping(value = "/api/neo/ekc")
public class EKeChengController {
    ...
    private static ResponseUtil ONE(){
        Driver driver = GraphDatabase.driver( URI, AuthTokens.basic( USERNAME, PASSWORD ) );
        Session session = driver.session();
        StatementResult result = session.run( "MATCH (s)- [:R]-> (t)- [:R] -> (p) return s,t,p");
